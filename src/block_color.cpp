...
static std::map<mcfile::blocks::BlockId, Color> const blockToColor {
    ...
    {mcfile::blocks::minecraft::cobbled_deepslate_slab, kColorCobbledDeepslate},
    {mcfile::blocks::minecraft::cobbled_deepslate_stairs, kColorCobbledDeepslate},
    {mcfile::blocks::minecraft::cobbled_deepslate_wall, kColorCobbledDeepslate},
    {mcfile::blocks::minecraft::polished_deepslate, kColorPolishedDeepslate},
    {mcfile::blocks::minecraft::polished_deepslate_slab, kColorPolishedDeepslate},
    {mcfile::blocks::minecraft::polished_deepslate_stairs, kColorPolishedDeepslate},
    {mcfile::blocks::minecraft::polished_deepslate_wall, kColorPolishedDeepslate},
    ...
    {mcfile::blocks::minecraft::exposed_cut_copper_slab, kColorCopperExposed},
    {mcfile::blocks::minecraft::exposed_cut_copper_stairs, kColorCopperExposed},
    {mcfile::blocks::minecraft::weathered_cut_copper, kColorCopperExposed},
    {mcfile::blocks::minecraft::weathered_cut_copper_slab, kColorCopperExposed},
    {mcfile::blocks::minecraft::weathered_cut_copper_stairs, kColorCopperExposed},
    {mcfile::blocks::minecraft::oxidized_cut_copper, kColorCopperOxidized},
    {mcfile::blocks::minecraft::oxidized_cut_copper_slab, kColorCopperOxidized},
    {mcfile::blocks::minecraft::oxidized_cut_copper_stairs, kColorCopperOxidized},
    ...
    {mcfile::blocks::minecraft::waxed_exposed_cut_copper_slab, kColorCopperExposed},
    {mcfile::blocks::minecraft::waxed_exposed_cut_copper_stairs, kColorCopperExposed},
    {mcfile::blocks::minecraft::waxed_weathered_cut_copper, kColorCopperWeathered},
    {mcfile::blocks::minecraft::waxed_weathered_cut_copper_slab, kColorCopperWeathered},
    {mcfile::blocks::minecraft::waxed_weathered_cut_copper_stairs, kColorCopperWeathered},
    {mcfile::blocks::minecraft::waxed_oxidized_cut_copper, kColorCopperOxidized},
    {mcfile::blocks::minecraft::waxed_oxidized_cut_copper_slab, kColorCopperOxidized},
    {mcfile::blocks::minecraft::waxed_oxidized_cut_copper_stairs, kColorCopperOxidized},
    ...
    {mcfile::blocks::minecraft::deepslate_brick_stairs, kColorDeepslateBricks},
    {mcfile::blocks::minecraft::deepslate_brick_slab, kColorDeepslateBricks},
    {mcfile::blocks::minecraft::deepslate_brick_wall, kColorDeepslateBricks},
    ...
    {mcfile::blocks::minecraft::deepslate_tile_slab, kColorDeepslateTiles},
    {mcfile::blocks::minecraft::deepslate_tile_stairs, kColorDeepslateTiles},
    {mcfile::blocks::minecraft::deepslate_tile_wall, kColorDeepslateTiles},
    ...
    {mcfile::blocks::minecraft::big_dripleaf, Color(111, 144, 44)},
    {mcfile::blocks::minecraft::azalea, Color(111, 144, 44)},
    {mcfile::blocks::minecraft::flowering_azalea, Color(111, 144, 44)},
    {mcfile::blocks::minecraft::azalea_leaves, Color(111, 144, 44)},
    {mcfile::blocks::minecraft::flowering_azalea_leaves, Color(111, 144, 44)},
    {mcfile::blocks::minecraft::soul_fire, Color(25, 215, 221)},
};
